...
--
INSERT into puesto_catering values (nextval('puest'), 1, 1, 9, 'Mixto'),
(nextval('puest'), 1, 1, 10, 'Mixto'),
(nextval('puest'), 1, 1, 13, 'Mixto'),
(nextval('puest'), 2, 1, 11, 'Comida'),
(nextval('puest'), 2, 1, 14, 'Comida'),
(nextval('puest'), 2, 1, 12, 'Mixto'),
(nextval('puest'), 1, 1, 21, 'Mixto'),
(nextval('puest'), 1, 1, 19, 'Mixto'),
(nextval('puest'), 2, 2, 20, 'Comida'),
(nextval('puest'), 2, 2, 18, 'Comida'),
(nextval('puest'), 2, 2, 16, 'Comida'),
(nextval('puest'), 5, 1, 17, 'Mixto'),
(nextval('puest'), 5, 1, 15, 'Mixto'),
(nextval('puest'), 6, 1, 3, 'Comida'),
(nextval('puest'), 6, 2, 3, 'Comida'),
(nextval('puest'), 6, 3, 3, 'Comida'),
(nextval('puest'), 6, 4, 3, 'Comida'),
(nextval('puest'), 6, 5, 5, 'Comida'),
(nextval('puest'), 6, 6, 4, 'Comida'),
(nextval('puest'), 6, 7, 4, 'Comida'),
(nextval('puest'), 6, 8, 4, 'Comida'),
(nextval('puest'), 6, 9, 4, 'Comida'),
(nextval('puest'), 6, 10, 6, 'Comida'),
(nextval('puest'), 7, 1, 3, 'Bebida'),
(nextval('puest'), 7, 2, 3, 'Bebida'),
(nextval('puest'), 7, 3, 3, 'Bebida'),
(nextval('puest'), 7, 4, 3, 'Bebida'),
(nextval('puest'), 7, 5, 5, 'Bebida'),
(nextval('puest'), 7, 6, 4, 'Bebida'),
(nextval('puest'), 7, 7, 4, 'Bebida'),
(nextval('puest'), 7, 8, 4, 'Bebida'),
(nextval('puest'), 7, 9, 5, 'Bebida'),
(nextval('puest'), 7, 10, 6, 'Bebida'),
(nextval('puest'), 8, 1, 3, 'Bebida'),
(nextval('puest'), 8, 2, 5, 'Bebida'),
(nextval('puest'), 8, 3, 4, 'Bebida'),
(nextval('puest'), 8, 4, 6, 'Bebida'),
(nextval('puest'), 9, 1, 3, 'Comida'),
(nextval('puest'), 9, 2, 3, 'Comida'),
(nextval('puest'), 9, 3, 3, 'Comida'),
(nextval('puest'), 9, 4, 4, 'Comida'),
(nextval('puest'), 9, 5, 4, 'Comida');
